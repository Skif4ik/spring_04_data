...
public class Main {
    public static void main(String[] args) {
       // var datasource = new DriverManagerDataSource(); работает только с одним соединением
        ...
        System.out.println("=======================================================");
        jdbcTemplate.query("SELECT * FROM user WHERE id > ?", new UserRowMapping(), new Object[]{1}).forEach(System.out::println);
